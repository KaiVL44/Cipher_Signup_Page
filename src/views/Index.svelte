<script>
  ...
  let foo = 'baz'
    ...
    console.log('in post');
		...
		const res = await fetch('https://localhost:5000/post', {
			method: 'POST',
			body: JSON.stringify({
				foo,
				bar
    ...
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        ...
        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
          Completely automatic doctor-patient transcription and note taking
        </p>
        <div class="mt-12">
          <form
          ...
          <form method="POST">
            ...
            <button class="roundEdges" on:click={subscribeUser}>Log in</button>
          </form>
        </div>
      </div>
    </div>
...
<!-- 
<section class="header relative pt-8 items-center flex h-screen max-h-860-px">
      ...
      <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
        ...
        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
          <div class="text-blueGray-400 text-center mb-3 font-bold">
            <small>Sign up to join the waitlist</small>
          </div>
          <form>
...
<section>
  <div class="container mx-auto overflow-hidden pb-20 pt-20">
    <div class="flex flex-wrap items-center mt-20">
     
      <div class="md:w-6/12 lg:w-6/12  px-15 md:px-4 ml-auto mr-auto mt-0">
        <div
          class="text-blueGray-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white"
        >
        <img alt="logo" src="/assets/img/logo.png" class="w-full align-middle">
        </div>
        <h3 class="text-3xl-dark-blue mb-2 font-bold leading-normal ciphertxt">
          Say goodbye to paperwork
        </h3>
        <h3 class="text-3xl-green mb-2 font-bold leading-normal">
          And hello to Cipher
        </h3>
        <p class="text-lg font-light leading-relaxed mt-4 text-blueGray-600">
          On average doctors using Cipher AI save 120 minutes per day. Directly integrated with your prefered EMR, Cipher transcribes notes, generates reports and referrals for practicioners
        </p>
      </div>


      <div class="relative flex flex-col min-w-0 break-words w-6/12 mb-0 shadow-lg rounded-lg bg-blueGray-200 border-0 mt-20">
        <div class="flex-auto px-4 lg:px-10 py-10 pt-2">
          <div class="text-blueGray-800 text-center mb-1 font-bold">
            <small>Sign up to join our waitlist</small>
          </div>
          <form>
            <div class="relative w-full mb-3">
              <label
...
<section class="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
  ...
  <div class="container mx-auto">
    <div class="flex flex-wrap items-center">
      <div
        class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-38"
      >
        <div
          class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-green-10"
        >
          <img
            alt="wireframe"
          ...
          <blockquote class="relative p-8 mb-4">
            ...
            >
              <polygon
                ...
                class="text-green-10 fill-current"
              ></polygon>
            </svg>
            ...
            <p class="text-md font-light mt-2 text-white">
              Cipher AI allows doctors to deliver a superior level of care to more patients than ever before
            </p>
          </blockquote>
        </div>
      </div>
          ...
          <div class="w-full md:w-6/12 px-4">
            <div class="relative flex flex-col mt-4">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  First Cipher AI will fully and accurately transcribe your entire doctor patient conversation
                </p>
              </div>
            </div>
            <div class="relative flex flex-col min-w-0">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  After this Cipher will generate comprehensive doctors notes & any other nessecary documents including referrals and reports
                </p>
              </div>
            </div>
          </div>
          <div class="w-full md:w-6/12 px-4">
            <div class="relative flex flex-col min-w-0 mt-4">
              <div class="px-4 py-5 flex-auto">
                ...
                <p class="mb-4 text-blueGray-500">
                  Using our specialist algorithm Cipher will detect all relevant information including medical history, diagnosis, medication and much more
                </p>
              </div>
            </div>
            <div class="relative flex flex-col min-w-0">
              <div class="px-4 py-5 flex-auto">
               ...
               />
                ...
                <p class="mb-4 text-blueGray-500">
                  After all this we will then automatically export notes to your favourite EMR & send any relevant referrals
                </p>
              </div>
            </div>
          </div>
